<?php 
  ...
  function enqueue_webpack_scripts() {
    ...
    // $cssFilePath = glob( get_template_directory() . '/dist/styles/gutunberg.css' );
    $cssFileURI = get_template_directory_uri() . '/dist/styles/gutunberg.css';
    wp_enqueue_style( 'main_css', $cssFileURI );
    
    // $jsFilePath = glob( get_template_directory() . '/js/build/main.min.*.js' );
    $jsFileURI = get_template_directory_uri() . '/dist/scripts/gutunberg.js';
