...
const DEFAULT_SET_MEDIA_LABEL = __('Set Image', 'infobeans-2023');
const DEFAULT_REPLACE_MEDIA_LABEL = __('Replace Image', 'infobeans-2023');
const DEFAULT_REMOVE_MEDIA_LABEL = __('Remove Image', 'infobeans-2023');
